...
CREATE TABLE segments(id uuid PRIMARY KEY, camera_id uuid REFERENCES cameras(id), start timestamp with time zone, stop timestamp with time zone, relative_path character varying, day_start timestamp with time zone);
